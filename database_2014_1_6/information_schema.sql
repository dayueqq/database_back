...
-- 转存表中的数据 `COLUMNS`
--
-- 使用中 (#1102 - Incorrect database name 'weixin - ')
...
(NULL, 'carfours', 'utf8', 'utf8_general_ci', NULL),
(NULL, 'guang', 'utf8', 'utf8_general_ci', NULL),
(NULL, 'mysql', 'utf8', 'utf8_general_ci', NULL),
(NULL, 'mytime', 'utf8', 'utf8_general_ci', NULL),
(NULL, 'report', 'utf8', 'utf8_general_ci', NULL),
(NULL, 'shop', 'utf8', 'utf8_general_ci', NULL),
(NULL, 'test', 'utf8', 'utf8_general_ci', NULL),
(NULL, 'weixin', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'weixin - ', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'weixin - ', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'weixin - ', 'latin1', 'latin1_swedish_ci', NULL);
...
('''hyc''@''%''', NULL, 'DROP', 'YES'),
('''hyc''@''%''', NULL, 'RELOAD', 'YES'),
('''hyc''@''%''', NULL, 'SHUTDOWN', 'YES'),
('''hyc''@''%''', NULL, 'PROCESS', 'YES'),
('''hyc''@''%''', NULL, 'FILE', 'YES'),
('''hyc''@''%''', NULL, 'REFERENCES', 'YES'),
('''hyc''@''%''', NULL, 'INDEX', 'YES'),
('''hyc''@''%''', NULL, 'ALTER', 'YES'),
('''hyc''@''%''', NULL, 'SHOW DATABASES', 'YES'),
('''hyc''@''%''', NULL, 'SUPER', 'YES'),
('''hyc''@''%''', NULL, 'CREATE TEMPORARY TABLES', 'YES'),
('''hyc''@''%''', NULL, 'LOCK TABLES', 'YES'),
('''hyc''@''%''', NULL, 'EXECUTE', 'YES'),
('''hyc''@''%''', NULL, 'REPLICATION SLAVE', 'YES'),
('''hyc''@''%''', NULL, 'REPLICATION CLIENT', 'YES'),
('''hyc''@''%''', NULL, 'CREATE VIEW', 'YES'),
('''hyc''@''%''', NULL, 'SHOW VIEW', 'YES'),
('''hyc''@''%''', NULL, 'CREATE ROUTINE', 'YES'),
('''hyc''@''%''', NULL, 'ALTER ROUTINE', 'YES'),
('''hyc''@''%''', NULL, 'CREATE USER', 'YES'),
('''carFours''@''%''', NULL, 'SELECT', 'NO'),
('''carFours''@''%''', NULL, 'INSERT', 'NO'),
('''carFours''@''%''', NULL, 'UPDATE', 'NO'),
('''carFours''@''%''', NULL, 'DELETE', 'NO'),
('''carFours''@''%''', NULL, 'FILE', 'NO'),
('''carFours''@''%''', NULL, 'EXECUTE', 'NO'),
('''carFours''@''%''', NULL, 'CREATE ROUTINE', 'NO'),
('''carFours''@''%''', NULL, 'ALTER ROUTINE', 'NO');
